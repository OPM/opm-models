...
function(opmFindUg)
  ...
  if(NOT UG_FOUND)
    ...
    string(REGEX REPLACE ".*-patch([0-9]*)" "\\1" UG_VERSION_PATCHLEVEL "${PACKAGE_VERSION}")

    # Adjust compiler/linker arguments
    set(UG_LIBRARY_DIR "${libdir}")

    list(INSERT UG_LIBRARIES 0 "-lugS2" "-lugS3")
    set(UG_LIBS "")
    foreach (UG_RAW_LIB ${UG_LIBRARIES})
    ...
    set(CMAKE_REQUIRED_DEFINITIONS ${CMAKE_REQUIRED_DEFINITIONS} ${UG_COMPILE_FLAGS})
  endif()
