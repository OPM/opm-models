    ...
    FVMPFAOPressure2PUpwind(Problem& problem) :
        problem_(problem), M_(problem.variables().gridSize(), problem.variables().gridSize(), (4 * dim + (dim - 1))
                * problem.variables().gridSize(), Dune::BCRSMatrix<MB>::random), f_(problem.variables().gridSize()),
                solverName_("Loop"), preconditionerName_("SeqPardiso")
    {
        initializeMatrix();
    }
...
void FVMPFAOPressure2PUpwind<TypeTag>::assemble()
{
    ...
    for (ElementIterator eIt = problem_.gridView().template begin<0> (); eIt != eItEnd; ++eIt)
    {
        ...
        for (IntersectionIterator isIt = isItBegin; isIt != isItEnd; ++isIt)
        {
            ...
            FieldMatrix lambda1(problem_.variables().upwindMobilitiesWetting(globalIdx1, indexInInside, 0));
            lambda1 += problem_.variables().upwindMobilitiesNonwetting(globalIdx1, indexInInside, 0);
            ...
            FieldMatrix lambda2(problem_.variables().upwindMobilitiesWetting(globalIdx1, indexInInside, 1));
            lambda2 += problem_.variables().upwindMobilitiesNonwetting(globalIdx1, indexInInside, 1);

            // get total mobility of neighbor cell 3
            FieldMatrix lambda3(problem_.variables().upwindMobilitiesWetting(globalIdx1, indexInInside, 2));
            lambda3 += problem_.variables().upwindMobilitiesNonwetting(globalIdx1, indexInInside, 2);
            ...
            if (isIt->neighbor())
            {
                ...
                if (nextisIt->neighbor())
                {
                                ...
                                != innernextisItEnd; ++innernextisIt)
                        {
                            if (innerisIt->neighbor() && innernextisIt->neighbor())
                            {
                                ...
                                if (innerisItoutside == innernextisItoutside && innerisItoutside != isIt->inside())
                                {
                                    ...
                                    lambda4 += problem_.variables().upwindMobilitiesWetting(globalIdx1, indexInInside,
                                            3);
                                    lambda4 += problem_.variables().upwindMobilitiesNonwetting(globalIdx1,
                                            indexInInside, 3);
                    ...
                    FieldMatrix lambdaK1(K1);
                    FieldMatrix lambdaK2(K2);
                    FieldMatrix lambdaK3(K3);
                    FieldMatrix lambdaK4(K4);

                    lambdaK1.leftmultiply(lambda1);
                    lambdaK2.leftmultiply(lambda2);
                    lambdaK3.leftmultiply(lambda3);
                    lambdaK4.leftmultiply(lambda4);

                    // compute components needed for flux calculation, denoted as 'g'
                    FieldVector<Scalar, dim> K1nu11(0);
                    lambdaK1.umv(nu11, K1nu11);
                    FieldVector<Scalar, dim> K1nu21(0);
                    lambdaK1.umv(nu21, K1nu21);
                    FieldVector<Scalar, dim> K2nu12(0);
                    lambdaK2.umv(nu12, K2nu12);
                    FieldVector<Scalar, dim> K2nu22(0);
                    lambdaK2.umv(nu22, K2nu22);
                    FieldVector<Scalar, dim> K3nu13(0);
                    lambdaK3.umv(nu13, K3nu13);
                    FieldVector<Scalar, dim> K3nu23(0);
                    lambdaK3.umv(nu23, K3nu23);
                    FieldVector<Scalar, dim> K4nu14(0);
                    lambdaK4.umv(nu14, K4nu14);
                    FieldVector<Scalar, dim> K4nu24(0);
                    lambdaK4.umv(nu24, K4nu24);
                    Scalar g111 = (integrationOuterNormaln1 * K1nu11) / dF1;
                    Scalar g121 = (integrationOuterNormaln1 * K1nu21) / dF1;
                    Scalar g211 = (integrationOuterNormaln3 * K1nu11) / dF1;
                    Scalar g221 = (integrationOuterNormaln3 * K1nu21) / dF1;
                    Scalar g112 = (integrationOuterNormaln1 * K2nu12) / dF2;
                    Scalar g122 = (integrationOuterNormaln1 * K2nu22) / dF2;
                    Scalar g212 = (integrationOuterNormaln4 * K2nu12) / dF2;
                    Scalar g222 = (integrationOuterNormaln4 * K2nu22) / dF2;
                    Scalar g113 = (integrationOuterNormaln2 * K3nu13) / dF3;
                    Scalar g123 = (integrationOuterNormaln2 * K3nu23) / dF3;
                    Scalar g213 = (integrationOuterNormaln3 * K3nu13) / dF3;
                    Scalar g223 = (integrationOuterNormaln3 * K3nu23) / dF3;
                    Scalar g114 = (integrationOuterNormaln2 * K4nu14) / dF4;
                    Scalar g124 = (integrationOuterNormaln2 * K4nu24) / dF4;
                    Scalar g214 = (integrationOuterNormaln4 * K4nu14) / dF4;
                    Scalar g224 = (integrationOuterNormaln4 * K4nu24) / dF4;
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            Scalar g123 = (integrationOuterNormaln2 * K3nu23) / dF3;
                            Scalar g213 = (integrationOuterNormaln3 * K3nu13) / dF3;
                            double g223 = (integrationOuterNormaln3 * K3nu23) / dF3;
                                    ...
                                    != isItThreeEnd; ++isItThree)
                            {
                                if (isItTwo->neighbor() && isItThree->neighbor())
                                {
                                    ...
                                    if (cellTwoNeighbor == cellThreeNeighbor && cellTwoNeighbor != *eIt)
                                    {
                                        ...
                                        {
                                            velocity12
                                                    = problem_.variables().velocity()[globalIdx][indexInInside]
                                                            + problem_.variables().velocitySecondPhase()[globalIdx][indexInInside];
                                            velocity13
                                                    = problem_.variables().velocity()[globalIdx][nextIndexInInside]
                                        ...
                                        {
                                            velocityInteractionVol[0] += faceArea21 * velocity12[0] + faceArea24
                                                    * velocity43[0];
                                            velocityInteractionVol[1] += faceArea11 * velocity13[1] + faceArea14
                                                    * velocity42[1];
                                        ...
                                        {
                                            velocityInteractionVol[0] += faceArea11 * velocity13[0] + faceArea14
                                                    * velocity42[0];
                                            velocityInteractionVol[1] += faceArea21 * velocity12[1] + faceArea24
                                                    * velocity43[1];
...
//                                        if (satUpw1 < 0 || satUpw2 < 0 || satUpw3 < 0 || satUpw4 < 0)
//                                        {
//                                            std::cout << "globalIdx " << globalIdx << ", indexInInside "
//                                                    << indexInInside << "\n";
//                                            std::cout << "satUpw1 = " << satUpw1 << "satUpw2 = " << satUpw2
//                                                    << "satUpw3 = " << satUpw3 << "satUpw4 = " << satUpw4 << "\n";
//                                        }
//                                        if (satUpw1 != satUpw2 || satUpw1 != satUpw3 || satUpw1 != satUpw4 || satUpw2 != satUpw3 || satUpw2 != satUpw4 || satUpw3 != satUpw4)
//                                        {
//                                            std::cout << "globalIdx " << globalIdx << ", indexInInside "
//                                                    << indexInInside << "\n";
//                                            std::cout << "satUpw1 = " << satUpw1 << "satUpw2 = " << satUpw2
//                                                    << "satUpw3 = " << satUpw3 << "satUpw4 = " << satUpw4 << "\n";
//
//                                            std::cout<<"velocity11 = "<<velocity12
//                                                    <<"\nvelocity21 = "<<velocity13
//                                                    <<"\nvelocity12 = "<<velocity42
//                                                    <<"\nvelocity22 = "<<velocity43<<"\n";
//
//                                            std::cout<<"velocityInteractionVol = "<<velocityInteractionVol<<"\n";
//
//                                            std::cout<<"unitOuterNormal11 = "<<unitOuterNormal11<<"\n";
//                                            std::cout<<"unitOuterNormal21 = "<<unitOuterNormal21<<"\n";
//                                            std::cout<<"unitOuterNormal12 = "<<unitOuterNormal12<<"\n";
//                                            std::cout<<"unitOuterNormal22 = "<<unitOuterNormal22<<"\n";
//                                            std::cout<<"unitOuterNormal13 = "<<unitOuterNormal13<<"\n";
//                                            std::cout<<"unitOuterNormal23 = "<<unitOuterNormal23<<"\n";
//                                            std::cout<<"unitOuterNormal14 = "<<unitOuterNormal14<<"\n";
//                                            std::cout<<"unitOuterNormal24 = "<<unitOuterNormal24<<"\n";
//
//                                            std::cout<<"potential11 = "<<potential11
//                                                    <<"\npotential21 = "<<potential21
//                                                    <<"\npotentialDiag1 = "<<potentialDiag1
//                                                    <<"\npotential12 = "<<potential12
//                                                    <<"\npotential22 = "<<potential22
//                                                    <<"\npotentialDiag2 = "<<potentialDiag2
//                                                    <<"\npotential13 = "<<potential13
//                                                    <<"\npotential23 = "<<potential23
//                                                    <<"\npotentialDiag3 = "<<potentialDiag3
//                                                    <<"\npotential14 = "<<potential14
//                                                    <<"\npotential24 = "<<potential24
//                                                    <<"\npotentialDiag4 = "<<potentialDiag4<<"\n";
//                                        }
                                        ...
                                        problem_.variables().upwindMobilitiesWetting(globalIdx, indexInInside, 0)
                                                = problem_.spatialParameters().krw(globalPos, *eIt, satUpw1);
                                        problem_.variables().upwindMobilitiesWetting(globalIdx, indexInInside, 0)
                                                /= viscosityW;
                                        problem_.variables().upwindMobilitiesNonwetting(globalIdx, indexInInside, 0)
                                                = problem_.spatialParameters().krn(globalPos, *eIt, satUpw1);
                                        problem_.variables().upwindMobilitiesNonwetting(globalIdx, indexInInside, 0)
                                                /= viscosityNW;
                                        problem_.variables().upwindMobilitiesWetting(globalIdx, indexInInside, 1)
                                                = problem_.spatialParameters().krw(globalPos2, *cellTwo, satUpw2);
                                        problem_.variables().upwindMobilitiesWetting(globalIdx, indexInInside, 1)
                                                /= viscosityW;
                                        problem_.variables().upwindMobilitiesNonwetting(globalIdx, indexInInside, 1)
                                                = problem_.spatialParameters().krn(globalPos2, *cellTwo, satUpw2);
                                        problem_.variables().upwindMobilitiesNonwetting(globalIdx, indexInInside, 1)
                                                /= viscosityNW;
                                        problem_.variables().upwindMobilitiesWetting(globalIdx, indexInInside, 2)
                                                = problem_.spatialParameters().krw(globalPos3, *cellThree, satUpw3);
                                        problem_.variables().upwindMobilitiesWetting(globalIdx, indexInInside, 2)
                                                /= viscosityW;
                                        problem_.variables().upwindMobilitiesNonwetting(globalIdx, indexInInside, 2)
                                                = problem_.spatialParameters().krn(globalPos3, *cellThree, satUpw3);
                                        problem_.variables().upwindMobilitiesNonwetting(globalIdx, indexInInside, 2)
                                                /= viscosityNW;
                                        problem_.variables().upwindMobilitiesWetting(globalIdx, indexInInside, 3)
                                                = problem_.spatialParameters().krw(globalPos4, *cellFour, satUpw4);
                                        problem_.variables().upwindMobilitiesWetting(globalIdx, indexInInside, 3)
                                                /= viscosityW;
                                        problem_.variables().upwindMobilitiesNonwetting(globalIdx, indexInInside, 3)
                                                = problem_.spatialParameters().krn(globalPos4, *cellFour, satUpw4);
                                        problem_.variables().upwindMobilitiesNonwetting(globalIdx, indexInInside, 3)
                                                /= viscosityNW;

                                        if (satUpw1 != satUpw2 || satUpw1 != satUpw3 || satUpw1 != satUpw4 || satUpw2 != satUpw3 || satUpw2 != satUpw4 || satUpw3 != satUpw4)
                                        {
                                            std::cout << "Upwind mobility W:\n"
                                                    << problem_.variables().upwindMobilitiesWetting(globalIdx,
                                                            indexInInside, 0) << "\n"
                                                    << problem_.variables().upwindMobilitiesWetting(globalIdx,
                                                            indexInInside, 1) << "\n"
                                                    << problem_.variables().upwindMobilitiesWetting(globalIdx,
                                            ...
                                            std::cout << "Upwind mobility NW:\n"
                                                    << problem_.variables().upwindMobilitiesNonwetting(globalIdx,
                                                            indexInInside, 0) << "\n"
                                                    << problem_.variables().upwindMobilitiesNonwetting(globalIdx,
                                                            indexInInside, 1) << "\n"
                                                    << problem_.variables().upwindMobilitiesNonwetting(globalIdx,
                        ...
                        if (nextIsItBCType == BoundaryConditions::dirichlet)
                        {
                            ...
                            if (isIt24BCType == BoundaryConditions::neumann)
                            {
                                ...
                                if (unitOuterNormal21[0] != 0)
                                {
                                    ...
                                    velocityInteractionVol[1] += faceArea11 * velocity13[1] + faceArea12
                                            * velocity24[1];
                                ...
                                {
                                    velocityInteractionVol[0] += faceArea11 * velocity13[0] + faceArea12
                                            * velocity24[0];
                                ...
                                problem_.variables().upwindMobilitiesWetting(globalIdx, indexInInside, 0)
                                        = problem_.spatialParameters().krw(globalPos, *eIt, satUpw1);
                                problem_.variables().upwindMobilitiesWetting(globalIdx, indexInInside, 0) /= viscosityW;
                                problem_.variables().upwindMobilitiesNonwetting(globalIdx, indexInInside, 0)
                                        = problem_.spatialParameters().krn(globalPos, *eIt, satUpw1);
                                problem_.variables().upwindMobilitiesNonwetting(globalIdx, indexInInside, 0)
                                        /= viscosityNW;
                                problem_.variables().upwindMobilitiesWetting(globalIdx, indexInInside, 1)
                                        = problem_.spatialParameters().krw(globalPos2, *cellTwo, satUpw2);
                                problem_.variables().upwindMobilitiesWetting(globalIdx, indexInInside, 1) /= viscosityW;
                                problem_.variables().upwindMobilitiesNonwetting(globalIdx, indexInInside, 1)
                                        = problem_.spatialParameters().krn(globalPos2, *cellTwo, satUpw2);
                                problem_.variables().upwindMobilitiesNonwetting(globalIdx, indexInInside, 1)
                                        /= viscosityNW;
                        ...
                        else if (nextIsItBCType == BoundaryConditions::neumann)
                        {
                            ...
                            if (isIt24BCType == BoundaryConditions::neumann)
                            {
                                ...
                                if (problem_.variables().potentialWetting(globalIdx, indexInInside) >= 0)
                                {
                                    ...
                                    problem_.variables().upwindMobilitiesWetting(globalIdx, indexInInside, 0)
                                            = problem_.spatialParameters().krw(globalPos, *eIt, satUpw);
                                    problem_.variables().upwindMobilitiesWetting(globalIdx, indexInInside, 0)
                                            /= viscosityW;
                                    problem_.variables().upwindMobilitiesNonwetting(globalIdx, indexInInside, 0)
                                            = problem_.spatialParameters().krn(globalPos, *eIt, satUpw);
                                    problem_.variables().upwindMobilitiesNonwetting(globalIdx, indexInInside, 0)
                                            /= viscosityNW;

                                    problem_.variables().upwindMobilitiesWetting(globalIdx, indexInInside, 1)
                                            = problem_.spatialParameters().krw(globalPos2, *cellTwo, satUpw);
                                    problem_.variables().upwindMobilitiesWetting(globalIdx, indexInInside, 1)
                                            /= viscosityW;
                                    problem_.variables().upwindMobilitiesNonwetting(globalIdx, indexInInside, 1)
                                            = problem_.spatialParameters().krn(globalPos2, *cellTwo, satUpw);
                                    problem_.variables().upwindMobilitiesNonwetting(globalIdx, indexInInside, 1)
                                            /= viscosityNW;
                ...
                else
                {
                    ...
                    if (nextIsIt->neighbor())
                    {
                        ...
                        if (isItBCType == BoundaryConditions::neumann)
                        {
                            ...
                            if (isIt34BCType == BoundaryConditions::dirichlet)
                            {
                                ...
                                if (unitOuterNormal21[0] != 0)
                                {
                                    velocityInteractionVol[0] += faceArea21 * velocity12[0] + faceArea23
                                            * velocity34[0];
                                ...
                                else
                                {
                                    ...
                                    velocityInteractionVol[1] += faceArea21 * velocity12[1] + faceArea23
                                            * velocity34[0];
                                ...
                                problem_.variables().upwindMobilitiesWetting(globalIdx, indexInInside, 2)
                                        = problem_.spatialParameters().krw(globalPos3, *cellThree, satUpw3);
                                problem_.variables().upwindMobilitiesWetting(globalIdx, indexInInside, 2) /= viscosityW;
                                problem_.variables().upwindMobilitiesNonwetting(globalIdx, indexInInside, 2)
                                        = problem_.spatialParameters().krn(globalPos3, *cellThree, satUpw3);
                                problem_.variables().upwindMobilitiesNonwetting(globalIdx, indexInInside, 2)
                                        /= viscosityNW;
                            ...
                            if (isIt34BCType == BoundaryConditions::neumann)
                            {
                                ...
                                if (problem_.variables().potentialWetting(globalIdx, nextIndexInInside) >= 0)
                                {
                                    ...
                                    problem_.variables().upwindMobilitiesWetting(globalIdx, indexInInside, 2)
                                            = problem_.spatialParameters().krw(globalPos3, *cellThree, satUpw);
                                    problem_.variables().upwindMobilitiesWetting(globalIdx, indexInInside, 2)
                                            /= viscosityW;
                                    problem_.variables().upwindMobilitiesNonwetting(globalIdx, indexInInside, 2)
                                            = problem_.spatialParameters().krn(globalPos3, *cellThree, satUpw);
                                    problem_.variables().upwindMobilitiesNonwetting(globalIdx, indexInInside, 2)
                                            /= viscosityNW;
                                }
                                else
                    ...
                    else
                    {
                        ...
                        if (isItBCType == BoundaryConditions::neumann)
                        {
                            ...
                            {
                                problem_.variables().upwindMobilitiesWetting(globalIdx, indexInInside, 0)
                                        = problem_.spatialParameters().krw(globalPos, *eIt,
                                                problem_.variables().saturation()[globalIdx]);
                                problem_.variables().upwindMobilitiesWetting(globalIdx, indexInInside, 0) /= viscosityW;
                                problem_.variables().upwindMobilitiesNonwetting(globalIdx, indexInInside, 0)
                                        = problem_.spatialParameters().krn(globalPos, *eIt,
                                                problem_.variables().saturation()[globalIdx]);
                                problem_.variables().upwindMobilitiesNonwetting(globalIdx, indexInInside, 0)
                                        /= viscosityNW;
                            }
        ...
        //        std::cout<<"Upwind mobility :\n"<<problem_.variables().upwindMobilitiesNonwetting(globalIdx, 0, 0)<<"\n"
        //                <<problem_.variables().upwindMobilitiesNonwetting(globalIdx, 1, 0)<<"\n"
        //                <<problem_.variables().upwindMobilitiesNonwetting(globalIdx, 2, 0)<<"\n"
        //                <<problem_.variables().upwindMobilitiesNonwetting(globalIdx, 3, 0)<<"\n";
