...
#include "dumux/new_decoupled/2p/diffusion/fvmpfa/fvmpfaopressure2pupwind_tensor.hh"
...
void FVMPFAOVelocities2P<TypeTag>::calculateVelocity()
{
    ...
    for (ElementIterator eIt = this->problem().gridView().template begin<0> (); eIt != eItEnd; ++eIt)
    {
        ...
        for (IntersectionIterator isIt = isItBegin; isIt != isItEnd; ++isIt)
        {
            ...
            FieldVector<FieldMatrix, numPhases> lambda1(FieldMatrix(0));
            ...
            FieldVector<FieldMatrix, numPhases> lambda2(FieldMatrix(0));
            FieldVector<FieldMatrix, numPhases> lambda3(FieldMatrix(0));
            ...
            if (isIt->neighbor())
            {
                ...
                if (nextisIt->neighbor())
                {
                    ...
                    FieldVector<FieldMatrix, numPhases> lambda4(FieldMatrix(0));
                    ...
                    for (int i = 0; i < numPhases; i++)
                    {
                        ...
                        lambdaK1.leftmultiply(lambda1[i]);
                        lambdaK2.leftmultiply(lambda2[i]);
                        lambdaK3.leftmultiply(lambda3[i]);
                        lambdaK4.leftmultiply(lambda4[i]);

                        if (lambdaK1.frobenius_norm() == 0 && lambdaK2.frobenius_norm() == 0
                                && lambdaK3.frobenius_norm() == 0 && lambdaK4.frobenius_norm() == 0)
                        {
                            continue;
                        }
                        ...
                        if (verbose && verbose > 2)
                            std::cout << "lambdaK1 " << i << " = " << lambdaK1[i] << "lambdaK2 " << i << " = "
                                    << lambdaK2[i] << "lambdaK3 " << i << " = " << lambdaK3[i] << "lambdaK4 " << i << " = "
                                    << lambdaK4[i] << "\n";
                        double g111 = (integrationOuterNormaln1 * K1nu11) / dF1;
                        double g121 = (integrationOuterNormaln1 * K1nu21) / dF1;
                        double g211 = (integrationOuterNormaln3 * K1nu11) / dF1;
                        double g221 = (integrationOuterNormaln3 * K1nu21) / dF1;
                        double g112 = (integrationOuterNormaln1 * K2nu12) / dF2;
                        double g122 = (integrationOuterNormaln1 * K2nu22) / dF2;
                        double g212 = (integrationOuterNormaln4 * K2nu12) / dF2;
                        double g222 = (integrationOuterNormaln4 * K2nu22) / dF2;
                        double g113 = (integrationOuterNormaln2 * K3nu13) / dF3;
                        double g123 = (integrationOuterNormaln2 * K3nu23) / dF3;
                        double g213 = (integrationOuterNormaln3 * K3nu13) / dF3;
                        double g223 = (integrationOuterNormaln3 * K3nu23) / dF3;
                        double g114 = (integrationOuterNormaln2 * K4nu14) / dF4;
                        double g124 = (integrationOuterNormaln2 * K4nu24) / dF4;
                        double g214 = (integrationOuterNormaln4 * K4nu14) / dF4;
                        double g224 = (integrationOuterNormaln4 * K4nu24) / dF4;
                    ...
                    else
                    {
                        ...
                        if (isIt34bctype == BoundaryConditions::neumann)
                        {
                            ...
                            for (int i = 0; i < numPhases; i++)
                            {
                                ...
                                if (lambdaK1.frobenius_norm() == 0 && lambdaK3.frobenius_norm() == 0)
                                {
                                    continue;
                                }
