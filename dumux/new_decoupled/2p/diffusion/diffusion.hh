...
public:
     ...
     */
    virtual void calculateVelocity(const Scalar t = 0)
    {
        return;
    }
    ...
    virtual const Problem& problem() const
    {
        return diffProblem;
    }
     ...
     */
    Diffusion(const GridView& gView, Problem& problem) :
        gridView(gView), diffProblem(problem)
    {
    }
