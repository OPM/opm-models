...
/*!
 * \file
 * \brief Base class for all problems which use the black-oil box model
 */
#ifndef DUMUX_BLACK_OIL_PROBLEM_HH
#define DUMUX_BLACK_OIL_PROBLEM_HH
...
class BlackOilProblem : public BoxMultiPhaseProblem<TypeTag>
{
...
public:
     ...
     */
    BlackOilProblem(TimeManager &timeManager,
