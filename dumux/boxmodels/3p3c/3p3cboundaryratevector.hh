 ...
 */
#ifndef DUMUX_BOX_3P3C_BOUNDARY_RATE_VECTOR_HH
#define DUMUX_BOX_3P3C_BOUNDARY_RATE_VECTOR_HH
...
class ThreePThreeCBoundaryRateVector
...
public:
     ...
     */
    ThreePThreeCBoundaryRateVector()
        : ParentType()
    { };
     ...
     */
    ThreePThreeCBoundaryRateVector(Scalar value)
        : ParentType(value)
    { };
     ...
     */
    ThreePThreeCBoundaryRateVector(const ThreePThreeCBoundaryRateVector &value)
        : ParentType(value)
    { };
