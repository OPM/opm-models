 ...
 */
#ifndef DUMUX_1P2C_PRIMARY_VARIABLES_HH
#define DUMUX_1P2C_PRIMARY_VARIABLES_HH
...
class OnePTwoCPrimaryVariables 
...
public:
     ...
     */
    OnePTwoCPrimaryVariables(Scalar value)
        : ParentType(value)
    { };
     ...
     */
    OnePTwoCPrimaryVariables(const OnePTwoCPrimaryVariables &value)
        : ParentType(value)
    { };
    ...
    void assignNaive(const FluidState &fluidState)
    {
        ...
        (*this)[x1Idx] = fluidState.moleFraction(/*phaseIdx=*/0, /*compIdx=*/1);
    }
};
