 ...
 */
#ifndef DUMUX_PVS_NI_FLUX_VARIABLES_HH
#define DUMUX_PVS_NI_FLUX_VARIABLES_HH
...
#include <dumux/boxmodels/pvs/pvsfluxvariables.hh>
...
class PvsNIFluxVariables : public PvsFluxVariables<TypeTag>
{
    typedef PvsFluxVariables<TypeTag> ParentType;
