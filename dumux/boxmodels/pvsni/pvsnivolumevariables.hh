 ...
 *        model.
 */
#ifndef DUMUX_PVS_NI_VOLUME_VARIABLES_HH
#define DUMUX_PVS_NI_VOLUME_VARIABLES_HH

#include <dumux/boxmodels/pvs/pvsvolumevariables.hh>
...
class PvsNIVolumeVariables : public PvsVolumeVariables<TypeTag>
{
    //! \cond 0
    typedef PvsVolumeVariables<TypeTag> ParentType;
...
protected:
    ...
    friend class PvsVolumeVariables<TypeTag>;
