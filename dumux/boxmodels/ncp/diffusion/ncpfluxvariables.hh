 ...
 */
#ifndef DUMUX_NCP_DIFFUSION_FLUX_VARIABLES_HH
#define DUMUX_NCP_DIFFUSION_FLUX_VARIABLES_HH
...
class NcpFluxVariablesDiffusion
{
...
class NcpFluxVariablesDiffusion<TypeTag, false>
{
    typedef typename GET_PROP_TYPE(TypeTag, GridView) GridView;
    typedef typename GET_PROP_TYPE(TypeTag, ElementContext) ElementContext;
...
#endif // DUMUX_NCP_DIFFUSION_FLUX_VARIABLES_HH
