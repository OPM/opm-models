 ...
 */
#ifndef DUMUX_BOX_2P2CNI_BOUNDARY_RATE_VECTOR_HH
#define DUMUX_BOX_2P2CNI_BOUNDARY_RATE_VECTOR_HH
...
class TwoPTwoCNIBoundaryRateVector
    : public TwoPTwoCBoundaryRateVector<TypeTag>
{
    typedef TwoPTwoCBoundaryRateVector<TypeTag> ParentType;
    friend class TwoPTwoCBoundaryRateVector<TypeTag>;
