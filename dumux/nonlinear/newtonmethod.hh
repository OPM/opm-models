...
SET_TYPE_PROP(NewtonMethod, NewtonMethod, Dumux::NewtonMethod<TypeTag>);
SET_TYPE_PROP(NewtonMethod, NewtonConvergenceWriter, Dumux::NullConvergenceWriter<TypeTag>);
