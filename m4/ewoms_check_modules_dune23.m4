dnl -*- autoconf -*-
# EWOMS_CHECK_MODULES_DUNE23(NAME, HEADER, SYMBOL)
#
...
#
# Generic check for dune modules for DUNE version 2.3 or above.  This
# macro should not be used directly, but in the modules m4/{module}.m4
# in the {MODULE}_CHECK_MODULE macro.  The {MODULE}_CHECK_MODULE macro
# knows the parameters to call this DUNE_CHECK_MODULES macro with, and
# it does not take any parameters itself, so it may be used with
# AC_REQUIRE.
#
...
#
# HEADER Name of the header to check for.
#
...
#   HAVE_{MODULE}
AC_DEFUN([EWOMS_CHECK_MODULES_DUNE23],[
