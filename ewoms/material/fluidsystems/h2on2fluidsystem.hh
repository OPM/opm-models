...
/*!
 * \file
 * \copydoc Ewoms::FluidSystems::H2ON2
 */
...
public:
                               ...
                               int phaseIdx)
    {
        ...
        if (useComplexRelations) {
            ...
            Scalar c_vN2molar = Ewoms::Constants<Scalar>::R*2.39;
            Scalar c_pN2molar = Ewoms::Constants<Scalar>::R + c_vN2molar;

            Scalar c_vH2Omolar = Ewoms::Constants<Scalar>::R*3.37; // <- correct??
            Scalar c_pH2Omolar = Ewoms::Constants<Scalar>::R + c_vH2Omolar;
