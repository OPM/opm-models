...
/*!
 * \file
 * \copydoc Ewoms::FluidSystems::Spe5
 */
...
{
    typedef Ewoms::FluidSystems::Spe5<Scalar> ThisType;
...
public:
    ...
    typedef Ewoms::Spe5ParameterCache<Scalar, ThisType> ParameterCache;
    ...
    static void init(Scalar minT = 273.15,
                     ...
                     Scalar maxP = 100e6)
    {
        Ewoms::PengRobinsonParamsMixture<Scalar, ThisType, gPhaseIdx, /*useSpe5=*/true> prParams;
