...
/*!
 * \file
 * \copydoc Ewoms::FluidSystems::H2OAirXylene
 */
...
public:
                                       ...
                                       int compIdx)
    {
        ...
        if (phaseIdx==gPhaseIdx) {
            Scalar diffAC = Ewoms::BinaryCoeff::Air_Xylene::gasDiffCoeff(fluidState.temperature(phaseIdx), fluidState.pressure(phaseIdx));
            Scalar diffWC = Ewoms::BinaryCoeff::H2O_Xylene::gasDiffCoeff(fluidState.temperature(phaseIdx), fluidState.pressure(phaseIdx));
            Scalar diffAW = Ewoms::BinaryCoeff::H2O_Air::gasDiffCoeff(fluidState.temperature(phaseIdx), fluidState.pressure(phaseIdx));
