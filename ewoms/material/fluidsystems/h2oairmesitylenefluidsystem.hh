...
/*!
 * \file
 * \copydoc Ewoms::FluidSystems::H2OAirMesitylene
 */
...
public:
                                       ...
                                       int compIdx)
    {
        ...
        if (phaseIdx==gPhaseIdx) {
            Scalar diffAC = Ewoms::BinaryCoeff::Air_Mesitylene::gasDiffCoeff(T, p);
            Scalar diffWC = Ewoms::BinaryCoeff::H2O_Mesitylene::gasDiffCoeff(T, p);
            Scalar diffAW = Ewoms::BinaryCoeff::H2O_Air::gasDiffCoeff(T, p);
