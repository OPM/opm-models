 ...
 * \code
 * int i;
 * Ewoms::Valgrind::CheckDefined(i); // Valgrind complains!
 * \endcode
 *
 ...
 * \code
 * int i[2];
 * Ewoms::Valgrind::CheckDefined(i, 2); // Valgrind complains!
 * \endcode
 *
 * \tparam T The type of the object which ought to be checked
 *
 ...
 * \code
 * int i[3] = {0, 1, 3};
 * Ewoms::Valgrind::SetUndefined(&i[1], 2);
 * Ewoms::Valgrind::CheckDefined(i, 3); // Valgrind complains!
 * \endcode
 *
 * \tparam T The type of the object which ought to be set to undefined
 *
 ...
 * \code
 * int i;
 * Ewoms::Valgrind::SetDefined(i);
 * Ewoms::Valgrind::CheckDefined(i); // Valgrind does not complain!
 * \endcode
 *
 ...
 * \code
 * int i[3];
 * Ewoms::Valgrind::SetDefined(i, 3);
 * Ewoms::Valgrind::CheckDefined(i, 3); // Valgrind does not complain!
 * \endcode
 *
 * \tparam T The type of the object which valgrind should consider as defined
 *
 ...
 * \code
 * int i[3] = {0, 1, 2};
 * Ewoms::Valgrind::SetNoAccess(i, 2);
