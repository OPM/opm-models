 ...
 * \file
 *
 * \copydoc Ewoms::StokesRateVector
 */
#ifndef EWOMS_STOKES_RATE_VECTOR_HH
#define EWOMS_STOKES_RATE_VECTOR_HH
...
public:
     ...
     */
    StokesRateVector(const Evaluation& value)
        : ParentType(value)
    {}
     ...
     */
    StokesRateVector(const StokesRateVector& value)
        : ParentType(value)
    {}
     ...
     */
    template <class RhsEval>
    StokesRateVector& operator=(const RhsEval& value)
    {
     ...
     */
    StokesRateVector& operator=(const StokesRateVector& other)
    {
        for (unsigned i=0; i < this->size(); ++i)
            (*this)[i] = other[i];
        return *this;
