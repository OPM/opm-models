 ...
 *****************************************************************************/
#ifndef EWOMS_CROPERATOR_HH
#define EWOMS_CROPERATOR_HH
...
#include<ewoms/decoupled/2p/diffusion/mimetic/localstiffness.hh>
...
/*!
 * \file
 * \copydoc Ewoms::CROperatorAssembler
 */
    ...
    */
    ...
    void assemble (LocalStiffness& loc, Vector& u, Vector& f)
    {
        ...
        for (Iterator it = gridView_.template begin<0>(); it!=eendit; ++it)
        {
            ...
            for (unsigned i=0; i<numFaces; i++) // loop over rows, i.e. test functions
            {
                // accumulate matrix
