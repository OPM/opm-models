 ...
 *****************************************************************************/
#ifndef EWOMS_LOCAL_STIFFNESS_HH
#define EWOMS_LOCAL_STIFFNESS_HH
...
namespace Ewoms
{
  ...
  public:
    ...
    typedef Dune::FieldVector<Scalar,m> VBlockType;                        // one entry in the global vectors
        typedef Dune::array<Ewoms::BoundaryConditions::Flags,m> BCBlockType; // componentwise boundary conditions
