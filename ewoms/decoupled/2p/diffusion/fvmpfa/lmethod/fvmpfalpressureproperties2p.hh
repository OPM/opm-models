 ...
 */
#ifndef EWOMS_FVMPFALPROPERTIES2P_HH
#define EWOMS_FVMPFALPROPERTIES2P_HH
...
#include <ewoms/decoupled/2p/diffusion/fvmpfa/lmethod/fvmpfal2pfaboundvelocity2p.hh>

namespace Ewoms
{
namespace Properties
{
SET_TYPE_PROP(FVMPFALPressureTwoP, PressureModel, Ewoms::FVMPFAL2PFABoundVelocity2P<TypeTag>);
}
