 ...
 *****************************************************************************/
#ifndef EWOMS_FVMPFAL2OFABOUNDPRESSURE2P_ADAPTIVE_HH
#define EWOMS_FVMPFAL2OFABOUNDPRESSURE2P_ADAPTIVE_HH

// eWoms includes
#include <ewoms/decoupled/common/fv/fvpressure.hh>
#include <ewoms/decoupled/common/fv/mpfa/mpfalinteractionvolume.hh>
...
/*!
 * \file
 * \copydoc Ewoms::FVMPFAL2PFABoundPressure2PAdaptive
 */
...
public:
     ...
     *
     */
    typedef Ewoms::FVMPFALInteractionVolume<TypeTag> InteractionVolume;
private:
...
template <class TypeTag>
const typename FVMPFAL2PFABoundPressure2PAdaptive<TypeTag>::Scalar
FVMPFAL2PFABoundPressure2PAdaptive<TypeTag>::threshold_ = 1e-15;
