 ...
 *****************************************************************************/
#ifndef EWOMS_FVMPFAO2OFABOUNDPRESSURE2P_HH
#define EWOMS_FVMPFAO2OFABOUNDPRESSURE2P_HH

// eWoms includes
#include <ewoms/decoupled/common/fv/fvpressure.hh>
#include <ewoms/decoupled/common/fv/mpfa/mpfaointeractionvolume.hh>
...
/*!
 * \file
 * \copydoc Ewoms::FVMPFAO2PFABoundPressure2P
 */
...
class FVMPFAO2PFABoundPressure2P: public FVPressure<TypeTag>
{
    ...
    typedef Ewoms::FVMPFAOInteractionVolume<TypeTag> InteractionVolume;
...
template <class TypeTag>
const typename FVMPFAO2PFABoundPressure2P<TypeTag>::Scalar
FVMPFAO2PFABoundPressure2P<TypeTag>::threshold_ = 1e-15;
