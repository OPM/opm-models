...
#ifndef EWOMS_FVPRESSUREPORPERTIES2P_DECOUPLED_HH
#define EWOMS_FVPRESSUREPORPERTIES2P_DECOUPLED_HH
...
SET_TYPE_PROP( FVPressureTwoP, Velocity, Ewoms::FVVelocity2P<TypeTag> );
//! Set finite volume implementation of the two-phase pressure equation as default pressure model
SET_TYPE_PROP(FVPressureTwoP, PressureModel, Ewoms::FVPressure2P<TypeTag>);
