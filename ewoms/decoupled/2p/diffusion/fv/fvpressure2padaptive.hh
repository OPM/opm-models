 ...
 *****************************************************************************/
#ifndef EWOMS_FVPRESSURE2P_ADAPTIVE_HH
#define EWOMS_FVPRESSURE2P_ADAPTIVE_HH

// eWoms includes
#include <ewoms/decoupled/2p/2pproperties.hh>
#include <ewoms/decoupled/2p/diffusion/fv/fvpressure2p.hh>
...
/*!
 * \file
 * \copydoc Ewoms::FVPressure2PAdaptive
 */
