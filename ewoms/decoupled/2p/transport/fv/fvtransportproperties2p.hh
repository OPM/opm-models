 ...
 *****************************************************************************/
#ifndef EWOMS_FV_TRANSPORT_PROPERTIES_2P_HH
#define EWOMS_FV_TRANSPORT_PROPERTIES_2P_HH
...
#include <ewoms/decoupled/2p/transport/fv/fvsaturation2p.hh>
...
SET_TYPE_PROP(FVTransportTwoP, TransportModel, Ewoms::FVSaturation2P<TypeTag>);
}
}
