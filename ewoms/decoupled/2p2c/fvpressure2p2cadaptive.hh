 ...
 *****************************************************************************/
#ifndef EWOMS_FVPRESSURE2P2C_ADAPTIVE_HH
#define EWOMS_FVPRESSURE2P2C_ADAPTIVE_HH
...
#include <ewoms/decoupled/2p/diffusion/fvmpfa/lmethod/fvmpfal2pfaboundpressure2padaptive.hh>
...
public:
            ...
            problem_(problem)
    {
        ...
        enableSecondHalfEdge = GET_PARAM(TypeTag,bool, MpfaEnableSecondHalfEdge);
            ...
            if (isIt->neighbor())
            {
                ...
                if (enableMPFA && enableSecondHalfEdge && isIt->outside()->level()!=eIt.level())
                {
                    ...
                    if(halfedgesStored == 2)
                    {
                        ...
                        for(unsigned i =0; i<foundAdditionals.size(); i++)
...
//                        }
    ...
    Ewoms::FVMPFALInteractionVolume<TypeTag> interactionVolume;
