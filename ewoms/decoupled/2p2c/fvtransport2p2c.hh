...
/*****************************************************************************
 *   Copyright (C) 2010-2013 by Benjamin Faigle                              *
 *                                                                           *
 ...
 *****************************************************************************/
#ifndef EWOMS_FVTRANSPORT2P2C_HH
#define EWOMS_FVTRANSPORT2P2C_HH
...
public:
    ...
    /*!
     * This method is called before first pressure equation is solved from Ewoms::IMPET.
     */
    void initialize()
    {
    ...
    {
        restrictFluxInTransport_ = GET_PARAM(TypeTag,bool, ImpetRestrictFluxInTransport);
    }
...
//    const int indexInOutside = intersection.indexInOutside();
    ...
    DimMatrix meanK_(0.);
    Ewoms::harmonicMeanMatrix(meanK_,
            K_I,
