 ...
 *   Copyright (C) 2009-2012 by Benjamin Faigle                              *
 *                                                                           *
 ...
 *****************************************************************************/
#ifndef EWOMS_IMPETPROBLEM_HH
#define EWOMS_IMPETPROBLEM_HH

#include "impetproperties.hh"
#include <ewoms/io/vtkmultiwriter.hh>
#include <ewoms/io/restart.hh>
#include <ewoms/io/adaptivegridrestart.hh>

#include <ewoms/decoupled/common/gridadapt.hh>
...
public:
    ...
    //! \copydoc Ewoms::IMPETProblem::timeManager()
    ...
    //! \copydoc Ewoms::IMPETProblem::variables ()
    ...
    //! \copydoc Ewoms::IMPETProblem::model()
    ...
    //! \copydoc Ewoms::IMPETProblem::pressureModel()
    ...
    //! \copydoc Ewoms::IMPETProblem::transportModel()
...
protected:
    ...
    //! \copydoc Ewoms::IMPETProblem::resultWriter()
