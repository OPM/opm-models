 ...
 *****************************************************************************/
#ifndef EWOMS_ONE_MODEL_PROBLEM_HH
#define EWOMS_ONE_MODEL_PROBLEM_HH
...
public:
     ...
     *  \tparam verbose Output level for Ewoms::TimeManager
     */
    ...
    /*!
     * \brief \copybrief Ewoms::OneModelProblem::timeManager()
     */
    ...
    /*!
     * \brief \copybrief Ewoms::OneModelProblem::variables()
     */
    ...
    /*!
     * \brief \copybrief Ewoms::OneModelProblem::model()
     */
...
private:
    ...
    //! \brief \copybrief Ewoms::OneModelProblem::asImp_()
