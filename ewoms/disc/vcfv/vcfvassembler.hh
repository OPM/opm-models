 ...
 * \file
 *
 * \copydoc Ewoms::VcfvAssembler
 */
#ifndef EWOMS_VCFV_ASSEMBLER_HH
#define EWOMS_VCFV_ASSEMBLER_HH
...
class VcfvAssembler
{
    ...
    VcfvAssembler(const VcfvAssembler &);
...
public:
    ...
    /*!
     * \brief Register all run-time parameters for the VCFV jacobian assembler.
     */
    ...
    void assemble()
    {
        ...
        catch (Ewoms::NumericalProblem &e)
        {
        ...
        for (unsigned i = 0; i < vertexColor_.size(); ++i) {
                           ...
                           const GlobalEqVector &uDelta)
    {
        ...
        // evaluation point
        for (unsigned i = 0; i < vertexDelta_.size(); ++i) {
