 ...
 * \file
 *
 * \copydoc Ewoms::VcfvLocalJacobian
 */
#ifndef EWOMS_VCFV_LOCAL_JACOBIAN_HH
#define EWOMS_VCFV_LOCAL_JACOBIAN_HH
 ...
 * \ingroup VcfvModel
 *
 * \brief Calculates the Jacobian of the local residual for VCVF discretizations
 *
...
private:
    ...
    VcfvLocalJacobian(const VcfvLocalJacobian &);
