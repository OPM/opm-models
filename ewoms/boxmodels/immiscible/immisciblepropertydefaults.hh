...
#include <ewoms/boxmodels/modules/velocity/boxvelocitymodules.hh>
#include <ewoms/boxmodels/common/boxmultiphaseproblem.hh>
...
SET_TYPE_PROP(BoxImmiscible, VelocityModule, Ewoms::BoxDarcyVelocityModule<TypeTag>);
...
SET_TYPE_PROP(BoxImmiscibleOnePhase, FluidSystem, Ewoms::FluidSystems::OneP<typename GET_PROP_TYPE(TypeTag, Scalar), typename GET_PROP_TYPE(TypeTag, Fluid)>);
