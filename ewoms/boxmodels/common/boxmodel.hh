 ...
 * \file
 *
 * \copydoc Ewoms::BoxModel
 */
#ifndef EWOMS_BOX_MODEL_HH
#define EWOMS_BOX_MODEL_HH
...
#include <ewoms/boxmodels/vtk/boxvtkoutputmodule.hh>
#include <ewoms/boxmodels/vtk/boxvtkprimaryvarsmodule.hh>
...
public:
    ...
    static void registerParameters()
    {
        ...
        Ewoms::BoxVtkPrimaryVarsModule<TypeTag>::registerParameters();
...
protected:
    ...
    void registerVtkModules_()
    {
        ...
        auto *vtkMod = new Ewoms::BoxVtkPrimaryVarsModule<TypeTag>(this->problem_());
