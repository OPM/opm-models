 ...
 * \file
 *
 * \copydoc Ewoms::BoxMultiPhaseProblem
 */
#ifndef EWOMS_BOX_MULTI_PHASE_PROBLEM_HH
#define EWOMS_BOX_MULTI_PHASE_PROBLEM_HH

#include <ewoms/boxmodels/common/boxproblem.hh>
...
{
    typedef Ewoms::BoxProblem<TypeTag> ParentType;
