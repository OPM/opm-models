 ...
 * \file
 *
 * \copydoc Ewoms::BoxConstraintsContext
 */
#ifndef EWOMS_BOX_CONSTRAINTS_CONTEXT_HH
#define EWOMS_BOX_CONSTRAINTS_CONTEXT_HH
...
public:
    ...
    /*!
     * \copydoc Ewoms::BoxElementContext::problem()
     */
    const Problem &problem() const
    { return elemCtx_.problem(); }

    /*!
     * \copydoc Ewoms::BoxElementContext::model()
     */
    const Model &model() const
    { return elemCtx_.model(); }

    /*!
     * \copydoc Ewoms::BoxElementContext::gridView()
     */
    const GridView &gridView() const
    { return elemCtx_.gridView(); }

    /*!
     * \copydoc Ewoms::BoxElementContext::element()
     */
    const Element &element() const
    { return elemCtx_.element(); }

    /*!
     * \copydoc Ewoms::BoxElementContext::numScv()
     */
    int numScv() const
    { return elemCtx_.numScv(); }

    /*!
     * \copydoc Ewoms::BoxElementContext::numScvf()
     */
    int numScvf() const
    { return elemCtx_.numScvf(); }

    /*!
     * \copydoc Ewoms::BoxElementContext::globalSpaceIndex
     */
    int globalSpaceIndex(int scvIdx, int timeIdx) const
    { return elemCtx_.globalSpaceIndex(scvIdx, timeIdx); }

    /*!
     * \copydoc Ewoms::BoxElementContext::pos
     */
