 ...
 * \file
 *
 * \copydoc Ewoms::BoxNewtonController
 */
#ifndef EWOMS_BOX_NEWTON_CONTROLLER_HH
#define EWOMS_BOX_NEWTON_CONTROLLER_HH
...
// set default values
SET_TYPE_PROP(BoxNewtonMethod, NewtonMethod, Ewoms::BoxNewtonMethod<TypeTag>);
SET_TYPE_PROP(BoxNewtonMethod, NewtonConvergenceWriter, Ewoms::BoxNewtonConvergenceWriter<TypeTag>);
