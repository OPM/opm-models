 ...
 * \file
 *
 * \copydoc Ewoms::BoxLocalResidual
 */
#ifndef EWOMS_BOX_LOCAL_RESIDUAL_HH
#define EWOMS_BOX_LOCAL_RESIDUAL_HH
...
private:
    ...
    typedef Ewoms::BoxConstraintsContext<TypeTag> ConstraintsContext;
    typedef Ewoms::BoxBoundaryContext<TypeTag> BoundaryContext;
