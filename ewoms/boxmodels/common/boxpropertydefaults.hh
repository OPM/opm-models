 ...
 */
#ifndef EWOMS_BOX_PROPERTY_DEFAULTS_HH
#define EWOMS_BOX_PROPERTY_DEFAULTS_HH
...
SET_TYPE_PROP(BoxModel, TimeManager, Ewoms::TimeManager<TypeTag>);
...
public:
    typedef Ewoms::BoxFVElementGeometry<Scalar, GridView> type;
};
...
SET_TYPE_PROP(BoxModel, BaseLocalResidual, Ewoms::BoxLocalResidual<TypeTag>);

//! Set the BaseModel to BoxModel
SET_TYPE_PROP(BoxModel, BaseModel, Ewoms::BoxModel<TypeTag>);

//! The local jacobian operator for the box scheme
SET_TYPE_PROP(BoxModel, LocalJacobian, Ewoms::BoxLocalJacobian<TypeTag>);
 ...
 */
SET_TYPE_PROP(BoxModel, Constraints, Ewoms::BoxConstraints<TypeTag>);
 ...
 */
SET_TYPE_PROP(BoxModel, VolumeVariables, Ewoms::BoxVolumeVariables<TypeTag>);

/*!
 * \brief An array of secondary variable containers.
 */
SET_TYPE_PROP(BoxModel, ElementContext, Ewoms::BoxElementContext<TypeTag>);

/*!
 * \brief Assembler for the global jacobian matrix.
 */
SET_TYPE_PROP(BoxModel, JacobianAssembler, Ewoms::BoxAssembler<TypeTag>);
...
SET_TYPE_PROP(BoxModel, LinearSolver, Ewoms::Linear::BoxParallelSolver<TypeTag>);
