...
#include <ewoms/boxmodels/vtk/boxvtkcompositionmodule.hh>
#include <ewoms/boxmodels/vtk/boxvtkphasepresencemodule.hh>
#include <ewoms/boxmodels/vtk/boxvtkdiffusionmodule.hh>
...
NEW_TYPE_TAG(BoxFlash, INHERITS_FROM(BoxModel, VtkPhasePresence, VtkMultiPhase, VtkComposition, VtkTemperature, VtkEnergy, VtkDiffusion));
