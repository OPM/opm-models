 ...
 * \file
 *
 * \copydoc Ewoms::BoxVtkDiffusionModule
 */
#ifndef EWOMS_BOX_VTK_DIFFUSION_MODULE_HH
#define EWOMS_BOX_VTK_DIFFUSION_MODULE_HH
...
class BoxVtkDiffusionModule : public BoxVtkOutputModule<TypeTag>
{
...
public:
    BoxVtkDiffusionModule(const Problem &problem)
        : ParentType(problem)
    { }
