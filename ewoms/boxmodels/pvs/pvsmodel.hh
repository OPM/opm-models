...
public:
    ...
    static void registerParameters()
    {
        ...
        Ewoms::BoxVtkPhasePresenceModule<TypeTag>::registerParameters();
        ...
        if (enableDiffusion)
            Ewoms::BoxVtkDiffusionModule<TypeTag>::registerParameters();

        if (enableEnergy)
            Ewoms::BoxVtkEnergyModule<TypeTag>::registerParameters();
...
private:
    ...
    void registerVtkModules_()
    {
        ...
        this->vtkOutputModules_.push_back(new Ewoms::BoxVtkPhasePresenceModule<TypeTag>(this->problem_()));
        ...
        if (enableDiffusion)
            this->vtkOutputModules_.push_back(new Ewoms::BoxVtkDiffusionModule<TypeTag>(this->problem_()));
        if (enableEnergy)
            this->vtkOutputModules_.push_back(new Ewoms::BoxVtkEnergyModule<TypeTag>(this->problem_()));
    }
